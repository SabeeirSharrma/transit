---
title: Binary Protocol (Advanced / Contributors)
description: Wire format specification for JS ↔ Java/Python communication.
---

:::note[For advanced users and contributors]
This document describes the wire format Transit uses to communicate between JavaScript and Java/Python. Most users do not need to read this — Transit handles all communication automatically. If you are just getting started, see [Getting Started](/guides/getting-started/) instead.
:::
