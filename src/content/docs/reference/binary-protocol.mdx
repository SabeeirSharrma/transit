...
> **Note on Rust, C, and C++:** These languages run in-process as native Node.js addons via the `RustDevBridge`. They **do not** use this binary protocol and communicate directly in-process with zero serialization overhead.
